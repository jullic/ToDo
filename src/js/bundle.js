...
/***/ "./src/js/modules/changeTypeTasks.js":
/*!*******************************************!*\
  !*** ./src/js/modules/changeTypeTasks.js ***!
  \*******************************************/
...
/* harmony export */   "changeTypeTasks": () => (/* binding */ changeTypeTasks),
/* harmony export */   "typeTask": () => (/* binding */ typeTask)
/* harmony export */ });
...
var changeTypeTasks = function changeTypeTasks() {
  var btns = document.querySelector('.todo__choose-btns');
...
/* harmony import */ var _changeTypeTasks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./changeTypeTasks */ "./src/js/modules/changeTypeTasks.js");
...
var task = function task() {
  var tasksContainer = document.querySelector('.todo__tasks');
  var addTaskBtn = document.querySelector('.todo__create-task');
  var place = document.querySelector('.todo__place');
  var typeTasks = document.querySelector('.todo__choose-btns');
  ...
  renderTasks(false, _changeTypeTasks__WEBPACK_IMPORTED_MODULE_5__.typeTask); // Accessory functions //
  ...
  function deleteTask(index) {
    ...
    renderTasks(false, _changeTypeTasks__WEBPACK_IMPORTED_MODULE_5__.typeTask);
    updateLocalStorage();
  } // Events //


  typeTasks.addEventListener('click', function () {
    renderTasks(false, !_changeTypeTasks__WEBPACK_IMPORTED_MODULE_5__.typeTask);
  });
  addTaskBtn.addEventListener('click', function () {
    tasks.push(new Task());
    renderTasks(true, _changeTypeTasks__WEBPACK_IMPORTED_MODULE_5__.typeTask);
    updateLocalStorage();
  });
  ...
  function createTaskList(obj) {
    ...
    obj.list.forEach(function (item, index) {
      ul.innerHTML += "\n            <li class=\"todo__task-list-item\">\n                <button class=\"todo__task-list-item-checkbox ".concat(item.completed, "\"  data-checkbox-index=\"").concat(index, "\"></button>\n                <input class=\"todo__task-list-item-text\" type=\"text\" value=\"").concat(item.text, "\">\n            </li>");
    });
    return ul;
  }
  ...
  function addInputEvent(task, index) {
    ...
    task.mainInput.addEventListener('input', function () {
      task.text = task.mainInput.value;
      updateLocalStorage();
    });
    task.descrInput = task.element.querySelector('.todo__task-descr');
    task.descrInput.addEventListener('input', function () {
    ...
    try {
      ...
      tasks.listInputs.forEach(function (input, i) {
  ...
  function renderTasks(lastTaskActive) {
    var typeTask = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_task__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/task */ "./src/js/modules/task.js");
/* harmony import */ var _modules_changeTypeTasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/changeTypeTasks */ "./src/js/modules/changeTypeTasks.js");


window.addEventListener('DOMContentLoaded', function () {
  (0,_modules_task__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_changeTypeTasks__WEBPACK_IMPORTED_MODULE_1__.changeTypeTasks)(); // const textareaHeight = document.querySelector('.todo__task-input');
